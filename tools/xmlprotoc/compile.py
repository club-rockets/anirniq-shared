"""CLang compilation of protocol.xml

    Transforms the protocol.xml into a C header containing #define macros for
    Message IDs.

    It does not transform or generate any other instructions for now. However,
    future plans could include:
        - Generating enums
        - Generating Node IDs (#defines )
"""
import sys
